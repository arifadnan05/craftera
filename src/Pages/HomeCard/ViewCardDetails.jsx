...
const ViewCardDetails = () => {
    ...
    const { item_name, photo, subcategory_Name, short_description, price, rating, stockStatus } = viewCard;
    return (
        <div className="card lg:card-side bg-base-100 my-16">
            <div className="w-[40%]">
                <figure><img className="rounded-xl" src={photo} /></figure>
            </div>
            <div className="card-body w-[60%]">
                <h2 className="card-title">{item_name}</h2>
                <p> <span className="font-bold mr-2">Category:</span> {subcategory_Name}</p>
