  ...
  return (
    <div>
      ...
      >
        ...
        <SwiperSlide>
          <>
            <div className="bg-[linear-gradient(45deg,rgba(0,0,0,0.4),rgba(0,0,0,0.5)),url('https://images.saatchiart.com/saatchi/809265/art/8624615/7688296-HSC00002-7.jpg')] flex flex-col items-center justify-center rounded-xl bg-[#15151580] bg-cover bg-center bg-no-repeat min-h-screen w-full">
        ...
        <SwiperSlide>
          <>
            <div className="bg-[linear-gradient(45deg,rgba(0,0,0,0.4),rgba(0,0,0,0.5)),url('https://images.saatchiart.com/saatchi/809265/art/8624615/7688296-HSC00002-7.jpg')] flex flex-col items-center justify-center bg-[#15151580] bg-cover bg-center bg-no-repeat min-h-[40vh] md:h-screen w-full">
              <div className='absolute md:top-[25%] flex flex-col items-center justify-center'>
                <h1 className='font-black text-xl md:text-3xl lg:text-6xl text-white'>The Saga of Rickshaw</h1>
